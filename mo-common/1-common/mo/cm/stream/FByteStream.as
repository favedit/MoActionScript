package mo.cm.stream
{
   ...
   // <P>实现输入输出流和数据输入流。</P>
   //============================================================
   public class FByteStream extends FBytes implements IInput, IOutput
   {
      //============================================================
      // <T>创建数据输入输出流。</T>
      //============================================================
      public function FByteStream(){
      }
      ...
      //============================================================
      [Inline]
      public final function writeBytes(pd:ByteArray, po:int = 0, pl:int = -1):void{
         if(pl < 0){
            pl = pd.length;
         }
      ...
      //============================================================
      [Inline]
      public final function skip(p:int):void{
         memory.position += p;
      }
